...
conn.adReply = async (msg) => {
    const quot = [{"key": {"remoteJid": "status@broadcast","fromMe": false,"participant": "0@s.whatsapp.net"},"message": {"contactMessage": {"displayName": '𝐙𝐞𝐭𝐚-𝐗𝐃 ㋚',"vcard": "BEGIN:VCARD\nVERSION:3.0\nN:"+'ezraaaa'+"\nFN:"+'ezraaaa'+"\nitem1.TEL;waid=919747257996:919747257996\nitem1.X-ABLabel:Click To Chat\nitem2.EMAIL;type=INTERNET:GitHub: Zeta-X0\nitem2.X-ABLabel:Follow Me On Github\nitem3.URL:YouTube: illa\nitem3.X-ABLabel:Youtube\nitem4.ADR:;;India, Kerala;;;;\nitem4.X-ABLabel:Region\nEND:VCARD"}}}]
    const zeta = quot[Math.floor(Math.random()*quot.length)];
    await message.client.sendMessage(message.jid, { text: msg, contextInfo: { externalAdReply: {
        title: "𝐳𝐞𝐭𝐚𝐚𝐚𝐡𝐡 ࿊", body: "", sourceUrl: "", mediaUrl: "", mediaType: 1,
        showAdAttribution: true, renderLargerThumbnail: false, thumbnailUrl: "https://i.imgur.com/rCB3S3B.jpeg"
    }}, quoted: zeta });
};
