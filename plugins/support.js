...
command({
    ...
    const name = 'ASTRO ☔', title = "Asᴛʀᴏ Sᴜᴘᴘᴏʀᴛ🧚‍♂️", number = '919846272202', body = "ASTRO☔";
    const image = "https://i.imgur.com/wmWj0BX.jpeg", sourceUrl = 'https://github.com/rikkubot/Izumi-v2';
